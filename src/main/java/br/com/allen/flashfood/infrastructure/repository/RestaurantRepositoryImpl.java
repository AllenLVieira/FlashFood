...
public class RestaurantRepositoryImpl implements RestaurantRepositoryQueries {
  ...
  @Autowired @Lazy private RestaurantRepository restaurantRepository;

  /**
   * @param name
   * @return restaurants with free shipping and by name obs: To avoid circular reference use
   *     the @Lazy annotation
   */
  @Override
  ...
  @Override
  public List<Restaurant> consultByNameAndBetweenFee(
  ...
  @Override
  public List<Restaurant> consultByNameAndBetweenFeeCriteria(
      String name, BigDecimal initialFee, BigDecimal finalFee) {
    ...
    if (initialFee != null) {
      predicates.add(builder.greaterThanOrEqualTo(root.get("freightRate"), initialFee));
    }
    if (finalFee != null) {
      predicates.add(builder.lessThanOrEqualTo(root.get("freightRate"), finalFee));
    }
