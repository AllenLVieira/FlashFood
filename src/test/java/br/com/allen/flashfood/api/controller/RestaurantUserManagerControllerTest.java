...
class RestaurantUserManagerControllerTest {
  @Autowired private RestaurantUserManagerController underTest;
  ...
  void testUnlinkManager() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder =
        MockMvcRequestBuilders.delete("/restaurants/{restaurantId}/managers/{userId}", 123L, 123L);
  ...
  void testGetAllManagers() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder =
        MockMvcRequestBuilders.get("/restaurants/{restaurantId}/managers", 123L);
  ...
  void testLinkManager() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder =
        MockMvcRequestBuilders.put("/restaurants/{restaurantId}/managers/{userId}", 123L, 123L);
    ResultActions actualPerformResult =
        MockMvcBuilders.standaloneSetup(underTest).build().perform(requestBuilder);
    actualPerformResult.andExpect(MockMvcResultMatchers.status().isNoContent());
  }
