...
class ApiExceptionHandlerTest {
    ...
    /**
     * Method under test: {@link ApiExceptionHandler#handleEntityNotFoundedException(EntityNotFoundedException, WebRequest)}
     */
    @Test
    void testHandleEntityNotFoundedException() {
        CityNotFoundException ex = new CityNotFoundException("An error occurred");
        ResponseEntity<?> actualHandleEntityNotFoundedExceptionResult = apiExceptionHandler
                .handleEntityNotFoundedException(ex, new ServletWebRequest(new MockHttpServletRequest()));
        ...
        assertEquals("Resource not found", ((ApiError) actualHandleEntityNotFoundedExceptionResult.getBody()).getTitle());
        assertEquals(404, ((ApiError) actualHandleEntityNotFoundedExceptionResult.getBody()).getStatus().intValue());
        assertNull(((ApiError) actualHandleEntityNotFoundedExceptionResult.getBody()).getUserMessage());
        assertEquals("An error occurred", ((ApiError) actualHandleEntityNotFoundedExceptionResult.getBody()).getDetail());
        assertNull(((ApiError) actualHandleEntityNotFoundedExceptionResult.getBody()).getFields());
        assertEquals("https://www.flashfood.com.br/resource-not-found",
    ...
    /**
     * Method under test: {@link ApiExceptionHandler#handleEntityInUseException(EntityInUseException, WebRequest)}
     */
    @Test
    void testHandleEntityInUseException() {
        EntityInUseException ex = new EntityInUseException("An error occurred");
        ResponseEntity<?> actualHandleEntityInUseExceptionResult = apiExceptionHandler.handleEntityInUseException(ex,
        ...
        assertEquals("Entity in use", ((ApiError) actualHandleEntityInUseExceptionResult.getBody()).getTitle());
        assertEquals(409, ((ApiError) actualHandleEntityInUseExceptionResult.getBody()).getStatus().intValue());
        assertEquals("An error occurred", ((ApiError) actualHandleEntityInUseExceptionResult.getBody()).getUserMessage());
        assertEquals("An error occurred", ((ApiError) actualHandleEntityInUseExceptionResult.getBody()).getDetail());
        assertNull(((ApiError) actualHandleEntityInUseExceptionResult.getBody()).getFields());
        assertEquals("https://www.flashfood.com.br/entity-in-use",
    ...
    /**
     * Method under test: {@link ApiExceptionHandler#handleBusinessException(BusinessException, WebRequest)}
     */
    @Test
    void testHandleBusinessException() {
        BusinessException ex = new BusinessException("An error occurred");
        ResponseEntity<?> actualHandleBusinessExceptionResult = apiExceptionHandler.handleBusinessException(ex,
                new ServletWebRequest(new MockHttpServletRequest()));
        ...
        assertEquals("Business rule violation", ((ApiError) actualHandleBusinessExceptionResult.getBody()).getTitle());
        assertEquals(400, ((ApiError) actualHandleBusinessExceptionResult.getBody()).getStatus().intValue());
        assertEquals("An error occurred", ((ApiError) actualHandleBusinessExceptionResult.getBody()).getUserMessage());
        assertEquals("An error occurred", ((ApiError) actualHandleBusinessExceptionResult.getBody()).getDetail());
        assertNull(((ApiError) actualHandleBusinessExceptionResult.getBody()).getFields());
        assertEquals("https://www.flashfood.com.br/business-error",
    ...
    /**
     * Method under test: {@link ApiExceptionHandler#handleExceptionInternal(Exception, Object, HttpHeaders, HttpStatus, WebRequest)}
     */
    @Test
    void testHandleExceptionInternal() {
        Exception ex = new Exception("An error occurred");
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleExceptionInternalResult = apiExceptionHandler.handleExceptionInternal(ex,
                "Body", headers, HttpStatus.CONTINUE, new ServletWebRequest(new MockHttpServletRequest()));
        ...
        assertEquals(100, ((ApiError) actualHandleExceptionInternalResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
    ...
    void testHandleExceptionInternal2() {
        Exception ex = new Exception("An error occurred");
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleExceptionInternalResult = apiExceptionHandler.handleExceptionInternal(ex, 1,
    ...
    void testHandleExceptionInternal3() {
        Exception ex = new Exception("An error occurred");
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleExceptionInternalResult = apiExceptionHandler.handleExceptionInternal(ex, null,
                headers, HttpStatus.CONTINUE, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleExceptionInternalResult.hasBody());
        assertTrue(actualHandleExceptionInternalResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.CONTINUE, actualHandleExceptionInternalResult.getStatusCode());
    ...
    void testHandleExceptionInternal5() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleExceptionInternalResult = apiExceptionHandler.handleExceptionInternal(ex,
                "Body", headers, HttpStatus.SWITCHING_PROTOCOLS, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleExceptionInternalResult.hasBody());
        assertTrue(actualHandleExceptionInternalResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.SWITCHING_PROTOCOLS, actualHandleExceptionInternalResult.getStatusCode());
        assertEquals("Body", ((ApiError) actualHandleExceptionInternalResult.getBody()).getTitle());
        assertEquals(101, ((ApiError) actualHandleExceptionInternalResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleExceptionInternalResult.getBody()).getUserMessage());
        assertNull(((ApiError) actualHandleExceptionInternalResult.getBody()).getDetail());
        assertNull(((ApiError) actualHandleExceptionInternalResult.getBody()).getFields());
    ...
    void testHandleExceptionInternal6() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleExceptionInternalResult = apiExceptionHandler.handleExceptionInternal(ex,
                "Body", headers, HttpStatus.PROCESSING, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleExceptionInternalResult.hasBody());
        assertTrue(actualHandleExceptionInternalResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.PROCESSING, actualHandleExceptionInternalResult.getStatusCode());
        assertEquals("Body", ((ApiError) actualHandleExceptionInternalResult.getBody()).getTitle());
        assertEquals(102, ((ApiError) actualHandleExceptionInternalResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleExceptionInternalResult.getBody()).getUserMessage());
        assertNull(((ApiError) actualHandleExceptionInternalResult.getBody()).getDetail());
        assertNull(((ApiError) actualHandleExceptionInternalResult.getBody()).getFields());
    ...
    void testHandleExceptionInternal7() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleExceptionInternalResult = apiExceptionHandler.handleExceptionInternal(ex,
                "Body", headers, HttpStatus.CHECKPOINT, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleExceptionInternalResult.hasBody());
        assertTrue(actualHandleExceptionInternalResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.CHECKPOINT, actualHandleExceptionInternalResult.getStatusCode());
        assertEquals("Body", ((ApiError) actualHandleExceptionInternalResult.getBody()).getTitle());
        assertEquals(103, ((ApiError) actualHandleExceptionInternalResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleExceptionInternalResult.getBody()).getUserMessage());
        assertNull(((ApiError) actualHandleExceptionInternalResult.getBody()).getDetail());
        assertNull(((ApiError) actualHandleExceptionInternalResult.getBody()).getFields());
    ...
    void testHandleExceptionInternal8() {
        Exception ex = new Exception("An error occurred");
        ResponseEntity<Object> actualHandleExceptionInternalResult = apiExceptionHandler.handleExceptionInternal(ex,
                "Body", new HttpHeaders(), HttpStatus.CONTINUE, mock(WebRequest.class));
        assertTrue(actualHandleExceptionInternalResult.hasBody());
        assertTrue(actualHandleExceptionInternalResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.CONTINUE, actualHandleExceptionInternalResult.getStatusCode());
        assertEquals("Body", ((ApiError) actualHandleExceptionInternalResult.getBody()).getTitle());
    ...
    /**
     * Method under test: {@link ApiExceptionHandler#handleHttpMessageNotReadable(HttpMessageNotReadableException, HttpHeaders, HttpStatus, WebRequest)}
     */
    @Test
    void testHandleHttpMessageNotReadable() {
        HttpMessageNotReadableException ex = new HttpMessageNotReadableException("https://example.org/example");
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleHttpMessageNotReadableResult = apiExceptionHandler
        ...
        assertEquals("Message not readable", ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getTitle());
        assertEquals(100, ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getUserMessage());
        assertEquals("The body of the request is invalid. Please check for syntax errors.",
        ...
        assertEquals("https://www.flashfood.com.br/message-not-readable",
    ...
    void testHandleHttpMessageNotReadable2() {
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleHttpMessageNotReadableResult = apiExceptionHandler
                .handleHttpMessageNotReadable(null, headers, HttpStatus.CONTINUE,
                        new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleHttpMessageNotReadableResult.hasBody());
        assertTrue(actualHandleHttpMessageNotReadableResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.CONTINUE, actualHandleHttpMessageNotReadableResult.getStatusCode());
    ...
    void testHandleHttpMessageNotReadable5() {
        ...
        assertEquals("Message not readable", ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getTitle());
        assertEquals(101, ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getUserMessage());
        assertEquals("The body of the request is invalid. Please check for syntax errors.",
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getDetail());
    ...
    void testHandleHttpMessageNotReadable6() {
        ...
        assertEquals("Message not readable", ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getTitle());
        assertEquals(102, ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getUserMessage());
        assertEquals("The body of the request is invalid. Please check for syntax errors.",
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getDetail());
    ...
    void testHandleHttpMessageNotReadable7() {
        ...
        assertEquals("Message not readable", ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getTitle());
        assertEquals(103, ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getUserMessage());
        assertEquals("The body of the request is invalid. Please check for syntax errors.",
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getDetail());
    ...
    void testHandleHttpMessageNotReadable8() {
        ...
        assertEquals("Message not readable", ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getTitle());
        assertEquals(200, ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getUserMessage());
        assertEquals("The body of the request is invalid. Please check for syntax errors.",
                ((ApiError) actualHandleHttpMessageNotReadableResult.getBody()).getDetail());
    ...
    /**
     * Method under test: {@link ApiExceptionHandler#handleTypeMismatch(TypeMismatchException, HttpHeaders, HttpStatus, WebRequest)}
     */
    @Test
    void testHandleTypeMismatch() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.CONTINUE, new ServletWebRequest(new MockHttpServletRequest()));
        ...
        assertEquals("Continue", ((ApiError) actualHandleTypeMismatchResult.getBody()).getTitle());
        ...
        assertNull(((ApiError) actualHandleTypeMismatchResult.getBody()).getDetail());
        assertNull(((ApiError) actualHandleTypeMismatchResult.getBody()).getFields());
        assertNull(((ApiError) actualHandleTypeMismatchResult.getBody()).getType());
    }
    ...
    void testHandleTypeMismatch2() {
        PropertyChangeEvent propertyChangeEvent = new PropertyChangeEvent(mock(MethodArgumentTypeMismatchException.class),
    ...
    void testHandleTypeMismatch3() {
        ...
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.CONTINUE, actualHandleTypeMismatchResult.getStatusCode());
        assertEquals("Invalid parameter", ((ApiError) actualHandleTypeMismatchResult.getBody()).getTitle());
        assertEquals(100, ((ApiError) actualHandleTypeMismatchResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleTypeMismatchResult.getBody()).getUserMessage());
        assertEquals(
        ...
        assertNull(((ApiError) actualHandleTypeMismatchResult.getBody()).getFields());
        assertEquals("https://www.flashfood.com.br/invalid-parameter",
    ...
    void testHandleTypeMismatch5() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.SWITCHING_PROTOCOLS, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    void testHandleTypeMismatch6() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.PROCESSING, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    void testHandleTypeMismatch7() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.CHECKPOINT, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    void testHandleTypeMismatch8() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.OK, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    void testHandleTypeMismatch10() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.CREATED, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    void testHandleTypeMismatch11() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.ACCEPTED, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    void testHandleTypeMismatch12() {
        ...
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.NON_AUTHORITATIVE_INFORMATION, actualHandleTypeMismatchResult.getStatusCode());
        assertEquals("Invalid parameter", ((ApiError) actualHandleTypeMismatchResult.getBody()).getTitle());
    ...
    void testHandleTypeMismatch13() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.NO_CONTENT, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    void testHandleTypeMismatch14() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.RESET_CONTENT, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    void testHandleTypeMismatch15() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleTypeMismatchResult = apiExceptionHandler.handleTypeMismatch(ex, headers,
                HttpStatus.PARTIAL_CONTENT, new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleTypeMismatchResult.hasBody());
        assertTrue(actualHandleTypeMismatchResult.getHeaders().isEmpty());
    ...
    /**
     * Method under test: {@link ApiExceptionHandler#handleNoHandlerFoundException(NoHandlerFoundException, HttpHeaders, HttpStatus, WebRequest)}
     */
    @Test
    void testHandleNoHandlerFoundException() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleNoHandlerFoundExceptionResult = apiExceptionHandler
        ...
        assertEquals("Resource not found", ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getTitle());
        assertEquals(100, ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getUserMessage());
        assertEquals("The resource 'https://example.org/example' do not exists. Correct and try again.",
    ...
    void testHandleNoHandlerFoundException4() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleNoHandlerFoundExceptionResult = apiExceptionHandler
                .handleNoHandlerFoundException(ex, headers, HttpStatus.SWITCHING_PROTOCOLS,
                        new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleNoHandlerFoundExceptionResult.hasBody());
        assertTrue(actualHandleNoHandlerFoundExceptionResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.SWITCHING_PROTOCOLS, actualHandleNoHandlerFoundExceptionResult.getStatusCode());
        assertEquals("Resource not found", ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getTitle());
        assertEquals(101, ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getUserMessage());
        assertEquals("The resource 'https://example.org/example' do not exists. Correct and try again.",
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getDetail());
    ...
    void testHandleNoHandlerFoundException5() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleNoHandlerFoundExceptionResult = apiExceptionHandler
                .handleNoHandlerFoundException(ex, headers, HttpStatus.PROCESSING,
                        new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleNoHandlerFoundExceptionResult.hasBody());
        assertTrue(actualHandleNoHandlerFoundExceptionResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.PROCESSING, actualHandleNoHandlerFoundExceptionResult.getStatusCode());
        assertEquals("Resource not found", ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getTitle());
        assertEquals(102, ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getUserMessage());
        assertEquals("The resource 'https://example.org/example' do not exists. Correct and try again.",
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getDetail());
    ...
    void testHandleNoHandlerFoundException6() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleNoHandlerFoundExceptionResult = apiExceptionHandler
                .handleNoHandlerFoundException(ex, headers, HttpStatus.CHECKPOINT,
                        new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleNoHandlerFoundExceptionResult.hasBody());
        assertTrue(actualHandleNoHandlerFoundExceptionResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.CHECKPOINT, actualHandleNoHandlerFoundExceptionResult.getStatusCode());
        assertEquals("Resource not found", ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getTitle());
        assertEquals(103, ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getUserMessage());
        assertEquals("The resource 'https://example.org/example' do not exists. Correct and try again.",
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getDetail());
    ...
    void testHandleNoHandlerFoundException7() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleNoHandlerFoundExceptionResult = apiExceptionHandler
                .handleNoHandlerFoundException(ex, headers, HttpStatus.OK,
                        new ServletWebRequest(new MockHttpServletRequest()));
        assertTrue(actualHandleNoHandlerFoundExceptionResult.hasBody());
        assertTrue(actualHandleNoHandlerFoundExceptionResult.getHeaders().isEmpty());
        assertEquals(HttpStatus.OK, actualHandleNoHandlerFoundExceptionResult.getStatusCode());
        assertEquals("Resource not found", ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getTitle());
        assertEquals(200, ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getStatus().intValue());
        assertEquals(ApiExceptionHandler.USER_MESSAGE,
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getUserMessage());
        assertEquals("The resource 'https://example.org/example' do not exists. Correct and try again.",
                ((ApiError) actualHandleNoHandlerFoundExceptionResult.getBody()).getDetail());
    ...
    void testHandleUncaught() {
        ...
        assertEquals(ApiExceptionHandler.USER_MESSAGE, ((ApiError) actualHandleUncaughtResult.getBody()).getDetail());
    ...
    /**
     * Method under test: {@link ApiExceptionHandler#handleMethodArgumentNotValid(MethodArgumentNotValidException, HttpHeaders, HttpStatus, WebRequest)}
     */
    @Test
    void testHandleMethodArgumentNotValid2() {
        ...
        HttpHeaders headers = new HttpHeaders();
        ResponseEntity<Object> actualHandleMethodArgumentNotValidResult = apiExceptionHandler
        ...
        assertEquals("Invalid data", ((ApiError) actualHandleMethodArgumentNotValidResult.getBody()).getTitle());
        assertEquals(100, ((ApiError) actualHandleMethodArgumentNotValidResult.getBody()).getStatus().intValue());
        assertEquals("One or more fields are invalid. Fill it correctly and try again.",
        ...
        assertTrue(((ApiError) actualHandleMethodArgumentNotValidResult.getBody()).getFields().isEmpty());
        assertEquals("https://www.flashfood.com.br/invalid-data",
