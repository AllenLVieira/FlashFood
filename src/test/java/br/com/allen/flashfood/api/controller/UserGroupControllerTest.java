...
class UserGroupControllerTest {
    @Autowired
    private UserGroupController underTest;
    ...
    void testLinkGroup() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/users/{userId}/groups/{groupId}", 123L,
                123L);
    ...
    void testUnlinkGroup() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/users/{userId}/groups/{groupId}",
                123L, 123L);
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(underTest)
                .build()
                .perform(requestBuilder);
    ...
    void testGetAllGroups() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/users/{userId}/groups", 1L);
