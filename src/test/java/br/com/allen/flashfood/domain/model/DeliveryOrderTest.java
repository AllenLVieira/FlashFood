...
class DeliveryOrderTest {
    ...
    void testConstructor() {
        ...
        assertEquals("DeliveryOrder(id=123, subtotal=42, freightRate=42, amount=42, deliveryAddress=Address(zipCode=21654,"
                        ...
                        + "=0001-01-01T01:01, updateDate=0001-01-01T01:01, cuisine=Cuisine(id=123, name=Name, restaurant=[]),"
                        + " products=[], paymentMethod=[]), cliente=User(id=123, name=Name, email=jane.doe@example.org,"
                        + " password=iloveyou, registrationDate=0001-01-01T01:01, groups=[]), items=[])",
                actualDeliveryOrder.toString());
    }
    ...
    void testEquals() {
        ...
        assertNotEquals(null, deliveryOrder);
    }
    ...
    void testEquals2() {
        ...
        deliveryOrder.setStatus(OrderStatus.CREATED);
        deliveryOrder.setSubtotal(BigDecimal.valueOf(42L));
        assertNotEquals("Different type to DeliveryOrder", deliveryOrder);
    }
    ...
    void testEquals3() {
        ...
        deliveryOrder.setStatus(OrderStatus.CREATED);
        deliveryOrder.setSubtotal(BigDecimal.valueOf(42L));
        assertEquals(deliveryOrder, deliveryOrder);
    ...
    void testEquals4() {
        ...
        deliveryOrder1.setStatus(OrderStatus.CREATED);
        deliveryOrder1.setSubtotal(BigDecimal.valueOf(42L));
        assertEquals(deliveryOrder, deliveryOrder1);
        int expectedHashCodeResult = deliveryOrder.hashCode();
    ...
    void testEquals5() {
        ...
        deliveryOrder1.setStatus(OrderStatus.CREATED);
        deliveryOrder1.setSubtotal(BigDecimal.valueOf(42L));
        assertNotEquals(deliveryOrder, deliveryOrder1);
    }
