...
class CityRegistrationServiceTest {
  ...
  @Autowired private CityRegistrationService underTest;

  @Mock private CityRepository cityRepository;

  private AutoCloseable autoCloseable;
  @Mock private StateRegistrationService stateService;
  ...
  void shouldThrowCityNotFoundExceptionWhenCityEmpty() {
    ...
    assertThrows(CityNotFoundException.class, () -> underTest.findCityOrElseThrow(123L));
    verify(cityRepository).findById(any());
  }
  ...
  void shouldThrowEmptyResultDataAccessExceptionWhenCityNotExists() {
    ...
    assertThrows(EmptyResultDataAccessException.class, () -> underTest.findCityOrElseThrow(123L));
    verify(cityRepository).findById(any());
  }
}
