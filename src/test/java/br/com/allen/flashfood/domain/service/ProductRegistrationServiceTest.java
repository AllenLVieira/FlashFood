...
class ProductRegistrationServiceTest {
    @Autowired
    private ProductRegistrationService underTest;
    ...
    void shouldFindProductById() {
        ...
        assertEquals("42", actualFindProductOrElseThrowResult.getRestaurant().getFreightRate().toString());
    ...
    void shouldThrowProductNotFoundExceptionWhenEmptyProduct() {
        ...
        assertThrows(ProductNotFoundException.class, () -> underTest.findProductOrElseThrow(123L, 123L));
        verify(productRepository).findById(any(), any());
    }
