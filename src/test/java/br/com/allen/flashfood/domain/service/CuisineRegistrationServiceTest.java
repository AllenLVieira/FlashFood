...
class CuisineRegistrationServiceTest {
  @Autowired private CuisineRegistrationService underTest;

  @MockBean private CuisineRepository cuisineRepository;
  ...
  void shouldThrowEmptyResultExceptionWhenTryToFind() {
    ...
    assertThrows(
        EmptyResultDataAccessException.class, () -> underTest.findCuisineOrElseThrow(123L));
    verify(cuisineRepository).findById(any());
  }
}
